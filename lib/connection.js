...
class Connection extends events.EventEmitter {
  ...
  _call (cmd, data, len, cb) {
    switch (cmd) {
      ...
      case 1: return this.end(cb)
      case 2: return this.read(data, cb)
      case 3: return this.close(cb)
    }
  }
  ...
  _onwrite (status) {
    ...
    writing.done(null, writing.length)
  }
  ...
  _notWritable (cb, data, len) {
    if (this._queued) {
      this._queued.push([data ? 0 : 1, data, len || 0, cb])
      return
    }
